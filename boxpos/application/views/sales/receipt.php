...
?>
<div id="receipt_wrapper standard_receipt">
...
<!--
   	<?php
	if(array_key_exists('Credit Card', $payments) || array_key_exists('Debit Card', $payments) || array_key_exists('Gift Card', $payments))
	{
		reset($paymentresponses[0]);
		while (list($key, $val) = each($paymentresponses[0]))
		{ ?>
			<tr>
			<td colspan="4" style="text-align:right;"><?php echo $key?> </td>
			<td colspan="2" style="text-align:right"><?php echo $val?>  </td>
		    </tr>
		<?php
		}
	}
