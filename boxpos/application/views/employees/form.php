...
<fieldset id="employee_basic_info" class="col-md-6 col-sm-12 col-xs-12">

<div class="page-header h2"><?php echo $this->lang->line("employees_basic_information"); ?></div>

<?php $this->load->view("people/form_basic_info"); ?>
</fieldset>

<fieldset id="employee_login_info">
<div class="page-header h2"><?php echo $this->lang->line("employees_login_info"); ?></div>

<div class="form-horizontal">
<div class="form-group">
<?php echo form_label($this->lang->line('employees_username').':', 'username',array('class'=>'required col-md-4 control-label')); ?>
	<div class="col-md-8">
...
<?php
$password_label_attributes = $person_info->person_id == "" ? array('class'=>'required col-md-4 control-label'):array();
?>
...
<div class="page-header h2"><?php echo $this->lang->line("employees_permission_info"); ?></div>
...
<span class="control-label"><?php echo $this->lang->line('module_'.$module->module_id);?>:</span>
...
<?php
	foreach($all_subpermissions->result() as $permission)
	{
		...
		<ul>
			...
			<span class="control-label"><?php echo $lang_line ?></span>
			</li>
		</ul>
			<?php 
		}
