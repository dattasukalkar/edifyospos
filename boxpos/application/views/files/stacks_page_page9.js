...
// Javascript for stacks_in_4_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_4_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_4_page9 = (function(stack) {
...
// Javascript for stacks_in_8_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_8_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_8_page9 = (function(stack) {
...
$(document).ready(function() {
  ...
  $("#stacks_in_8_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_8_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_8_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_8_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_1854_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_1854_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_1854_page9 = (function(stack) {
...
$(document).ready(function() {
	$("#stacks_in_1854_page9").parent().css("overflow","visible");
...
// Javascript for stacks_in_15_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_15_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_15_page9 = (function(stack) {
...
$(document).ready(function() {
    //$(".menuGrid_stacks_in_15_page9:parent").addClass("whahtathathahtahhaahahahahahahahahahahahahahahahahahahahaha");
  $("#stacks_in_15_page9").parent().css("overflow","visible");
  $("#stacks_in_15_page9").parent().addClass("changePosition");

  $("#pureMenu_stacks_in_15_page9 li").has("ul").addClass( "has-sub" );
  $("#pureMenu_stacks_in_15_page9 ul li:last-child").addClass("last");
  
  $('#menu_stacks_in_15_page9').mmenu();
  $('#pureMenu_stacks_in_15_page9 > ul').css("opacity",1);
  $('#menu_stacks_in_15_page9').css("opacity",1);
});
$(window).load(function() {
  
    if ($('#stacks_in_15_page9').parents('.com_onelittledesigner_stacks_Pure_Grids_stack').length) {
        $('#stacks_in_15_page9').parent().parent().parent().parent('.com_onelittledesigner_stacks_Pure_Grids_stack').addClass("menuGrid_stacks_in_15_page9");
        
    } else {
  
      $('#pureMenu_stacks_in_15_page9').addClass("menuGrid_stacks_in_15_page9");
...
// Javascript for stacks_in_27_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_27_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_27_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_27_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_27_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_27_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_27_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_34_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_34_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_34_page9 = (function(stack) {
...
(function(module){if(typeof define==="function"&&define.amd)define(["jquery"],module);else module(jQuery)})(function(jQuery,undefined){var add=jQuery.event.add,remove=jQuery.event.remove,trigger=function(node,type,data){jQuery.event.trigger(type,data,node)},settings={threshold:.4,sensitivity:6};function moveend(e){var w,h,event;w=e.currentTarget.offsetWidth;h=e.currentTarget.offsetHeight;event={distX:e.distX,distY:e.distY,velocityX:e.velocityX,velocityY:e.velocityY,finger:e.finger};if(e.distX>e.distY)if(e.distX>
-e.distY){if(e.distX/w>settings.threshold||e.velocityX*e.distX/w*settings.sensitivity>1){event.type="swiperight";trigger(e.currentTarget,event)}}else{if(-e.distY/h>settings.threshold||e.velocityY*e.distY/w*settings.sensitivity>1){event.type="swipeup";trigger(e.currentTarget,event)}}else if(e.distX>-e.distY){if(e.distY/h>settings.threshold||e.velocityY*e.distY/w*settings.sensitivity>1){event.type="swipedown";trigger(e.currentTarget,event)}}else if(-e.distX/w>settings.threshold||e.velocityX*e.distX/
w*settings.sensitivity>1){event.type="swipeleft";trigger(e.currentTarget,event)}}function getData(node){var data=jQuery.data(node,"event_swipe");if(!data){data={count:0};jQuery.data(node,"event_swipe",data)}return data}jQuery.event.special.swipe=jQuery.event.special.swipeleft=jQuery.event.special.swiperight=jQuery.event.special.swipeup=jQuery.event.special.swipedown={setup:function(data,namespaces,eventHandle){var data=getData(this);if(data.count++>0)return;add(this,"moveend",moveend);return true},
teardown:function(){var data=getData(this);if(--data.count>0)return;remove(this,"moveend",moveend);return true},settings:settings}});
/**
 *   Unslider by @idiot
 */
(function($,f){var Unslider=function(){var _=this;_.o={speed:500,delay:3E3,init:0,pause:!f,loop:!f,keys:f,dots:f,arrows:f,prev:"&larr;",next:"&rarr;",fluid:f,starting:f,complete:f,items:">ul",item:">li",easing:"swing",autoplay:true};_.init=function(el,o){_.o=$.extend(_.o,o);_.el=el;_.ul=el.find(_.o.items);_.max=[el.outerWidth()|0,el.outerHeight()|0];_.li=_.ul.find(_.o.item).each(function(index){var me=$(this),width=me.outerWidth(),height=me.outerHeight();if(width>_.max[0])_.max[0]=width;if(height>
_.max[1])_.max[1]=height});var o=_.o,ul=_.ul,li=_.li,len=li.length;_.i=0;el.css({width:_.max[0],height:li.first().outerHeight(),overflow:"hidden"});ul.css({position:"relative",left:0,width:(len*100)+1+"%"});if(o.fluid)li.css({"float":"left",width:100/len+"%"});else li.css({"float":"left",width:_.max[0]+"px"});o.autoplay&&setTimeout(function(){if(o.delay|0){_.play();if(o.pause)el.on("mouseover mouseout",function(e){_.stop();e.type=="mouseout"&&_.play()})}},o.init|0);if(o.keys)$(document).keydown(function(e){var key=
e.which;if(key==37)_.prev();else if(key==39)_.next();else if(key==27)_.stop()});o.dots&&nav("dot");o.arrows&&nav("arrow");if(o.fluid)$(window).resize(function(){_.r&&clearTimeout(_.r);_.r=setTimeout(function(){var styl={height:li.eq(_.i).outerHeight()},width=el.outerWidth();ul.css(styl);styl["width"]=Math.min(Math.round(width/el.parent().width()*100),100)+"%";el.css(styl);li.css({width:width+"px"})},50)}).resize();if($.event.special["move"]||$.Event("move"))el.on("movestart",function(e){if(e.distX>
e.distY&&e.distX<-e.distY||e.distX<e.distY&&e.distX>-e.distY)e.preventDefault();else el.data("left",_.ul.offset().left/el.width()*100)}).on("move",function(e){var left=100*e.distX/el.width();_.ul.css("left",el.data("left")+left+"%");_.ul.data("left",left)}).on("moveend",function(e){var left=_.ul.data("left");if(Math.abs(left)>30){var i=left>0?_.i-1:_.i+1;if(i<0||i>=len)i=_.i;_.to(i)}else _.to(_.i)});return _};_.to=function(index,callback){if(_.t){_.stop();_.play()}var o=_.o,el=_.el,ul=_.ul,li=_.li,
current=_.i,target=li.eq(index);$.isFunction(o.starting)&&!callback&&o.starting(el,li.eq(current));if((!target.length||index<0)&&o.loop==f)return;if(!target.length)index=0;if(index<0)index=li.length-1;target=li.eq(index);var speed=callback?5:o.speed|0,easing=o.easing,obj={height:target.outerHeight()};if(!ul.queue("fx").length){el.find(".dot").eq(index).addClass("active").siblings().removeClass("active");el.animate(obj,speed,easing)&&ul.animate($.extend({left:"-"+index+"00%"},obj),speed,easing,function(data){_.i=
index;$.isFunction(o.complete)&&!callback&&o.complete(el,target)})}};_.play=function(){_.t=setInterval(function(){_.to(_.i+1)},_.o.delay|0)};_.stop=function(){_.t=clearInterval(_.t);return _};_.next=function(){return _.stop().to(_.i+1)};_.prev=function(){return _.stop().to(_.i-1)};function nav(name,html){if(name=="dot"){html='<ol class="dots">';$.each(_.li,function(index){html+='<li class="'+(index==_.i?name+" active":name)+'">'+ ++index+"</li>"});html+="</ol>"}else{html='<div class="';html=html+
name+'s">'+html+name+' prev">'+_.o.prev+"</div>"+html+name+' next">'+_.o.next+"</div></div>"}_.el.addClass("has-"+name+"s").append(html).find("."+name).click(function(){var me=$(this);me.hasClass("dot")?_.stop().to(me.index()):me.hasClass("prev")?_.prev():_.next()})}};$.fn.unslider=function(o){var len=this.length;return this.each(function(index){var me=$(this),key="unslider"+(len>1?"-"+ ++index:""),instance=(new Unslider).init(me,o);me.data(key,instance).data("key",key)})};Unslider.version="1.0.0"})(jQuery,
false);



$(window).load(function() {
	var unslider_stacks_in_34_page9 =  $('#stacks_in_34_page9 .banner_stacks_in_34_page9').unslider({
		autoplay: false,
    ...
    $(".loadingDiv").fadeOut(300,function(){$(this).remove();});
    $('#stacks_in_34_page9 .unslider-arrow').click(function() {
        var fn = this.className.split(' ')[1];
        
        //  Either do unslider.data('unslider').next() or .prev() depending on the className
        unslider_stacks_in_34_page9.data('unslider')[fn]();
    });
});	
...
$(document).ready(function() {
	$("#stacks_in_34_page9").parent().css({
		"overflow" : "visible"
	});
	
	$("#stacks_in_34_page9 li").each(function(index, value) { 
		if ($(this).find('.imageStyle').length) {
		    $(this).find(".sliderCaption").css("background-image" ,"url('"+jQuery("> .centered_image .imageStyle", this).attr("src")+"')");
		}
	});
});
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_55_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_55_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_55_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_55_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_62_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_62_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_62_page9 = (function(stack) {
...
$(document).ready(function() {
  $("#stacks_in_62_page9").parent().css("overflow","visible");
});
...
// Javascript for stacks_in_64_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_64_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_64_page9 = (function(stack) {
...
$(document).ready(function() {
  $("#stacks_in_64_page9").parent().css("overflow","visible");
});
...
// Javascript for stacks_in_66_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_66_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_66_page9 = (function(stack) {
...
$(document).ready(function() {
	$("#stacks_in_66_page9").parent().css("overflow","visible");
...
// Javascript for stacks_in_101_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_101_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_101_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_101_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_101_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_101_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_101_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_68_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_68_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_68_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_68_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_5222_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_5222_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_5222_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_5222_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_5222_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_5222_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_5222_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_5259_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_5259_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_5259_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_5259_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_5259_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_5259_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_5259_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_5233_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_5233_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_5233_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_5233_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_5233_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_5233_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_5233_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_5244_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_5244_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_5244_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_5244_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_5244_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_5244_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_5244_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_108_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_108_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_108_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_108_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_108_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_108_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_108_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_75_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_75_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_75_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_75_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_75_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_75_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_75_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
// Javascript for stacks_in_92_page9
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_92_page9 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_92_page9 = (function(stack) {
...
$(document).ready(function() {
  //Change ID to One Page Scroll Menu ID
  $("#stacks_in_92_page9").parent().addClass("s0_pure");
  
  var childNumber = 0;
  $("#stacks_in_92_page9 > .pure-g > .pure-u-1").each(function( index ) {
    if(!$(this).not(":hidden").length == 0){
      childNumber++;
      $(this).addClass("child-"+childNumber);
    }
  });
  $("#stacks_in_92_page9 > .pure-g > .pure-u-1.child-"+childNumber).addClass("last-child");
  $("#stacks_in_92_page9").parent().css({
    "overflow" : "visible",
    "width" : "100%"
  });
...
$(document).ready(function() {
    //$(".menuGrid_stacks_in_82_page9:parent").addClass("whahtathathahtahhaahahahahahahahahahahahahahahahahahahahaha");
  $("#stacks_in_82_page9").parent().css("overflow","visible");
  $("#stacks_in_82_page9").parent().addClass("changePosition");

  $("#pureMenu_stacks_in_82_page9 li").has("ul").addClass( "has-sub" );
  $("#pureMenu_stacks_in_82_page9 ul li:last-child").addClass("last");
  
  $('#menu_stacks_in_82_page9').mmenu();
  $('#pureMenu_stacks_in_82_page9 > ul').css("opacity",1);
  $('#menu_stacks_in_82_page9').css("opacity",1);
});
$(window).load(function() {
  
    if ($('#stacks_in_82_page9').parents('.com_onelittledesigner_stacks_Pure_Grids_stack').length) {
        $('#stacks_in_82_page9').parent().parent().parent().parent('.com_onelittledesigner_stacks_Pure_Grids_stack').addClass("menuGrid_stacks_in_82_page9");
        
        	$('#stacks_in_82_page9').parent().parent().parent().parent('.com_onelittledesigner_stacks_Pure_Grids_stack').css({
        		position: "absolute",
        		width: "100%"
        	});
      ...
      $('#pureMenu_stacks_in_82_page9').addClass("menuGrid_stacks_in_82_page9");
      
        	$('#pureMenu_stacks_in_82_page9').css({
        		position: "absolute",
        		width: "100%"
        	});
