...
<?php echo form_label($this->lang->line('giftcards_person_id').':', 'name',array('class'=>'required col-md-4 control-label')); ?>
	<div class="col-md-8">
...
<div class="form-group">
<?php echo form_label($this->lang->line('giftcards_giftcard_number').':', 'name',array('class'=>'required col-md-4 control-label')); ?>
	<div class="col-md-8">
	<?php echo form_input(array(
...
<div class="form-group">
<?php echo form_label($this->lang->line('giftcards_card_value').':', 'name',array('class'=>'required col-md-4 control-label')); ?>
	<div class="col-md-8">
	<?php echo form_input(array(
		'name'=>'value',
		'id'=>'value',
