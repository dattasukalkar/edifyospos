	...
	<div class="col-md-6 col-sm-12 col-xs-12">
		<div class="">
			<?php echo anchor("$controller_name/view/-1/width:$form_width",
                        "<div class='btn btn-default btn-block'><span>".$this->lang->line($controller_name.'_new')."</span></div>",
	...
	<div class="col-md-6 col-sm-12 col-xs-12">
		<div id="new_button">
			<?php echo anchor("$controller_name/excel_import/width:$form_width",
				"<div class='btn btn-default btn-block'><span>Excel Import</span></div>",
...
<div class="container-fluid">
	<div id="table_action_header">
		<ul>
			...
			<li class="btn btn-default"><span><?php echo anchor("$controller_name/bulk_edit/width:$form_width",$this->lang->line("items_bulk_edit"),array('id'=>'bulk_edit','title'=>$this->lang->line('items_edit_multiple_items'))); ?></span></li>
