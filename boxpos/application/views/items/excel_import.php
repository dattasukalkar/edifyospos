...
<div class="page-header h1">Import items from Excel sheet</div>
...
<div class="panel panel-default">
	...
	<a href="<?php echo site_url('items/excel'); ?>">Download Import Excel Template (CSV)</a>
	</div>
</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="field_row clearfix">
			<?php echo form_label('File path:', 'name',array('class'=>'label')); ?>
		</div>
