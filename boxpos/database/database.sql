...
-- EdifyNowComment Line Added : Start --
--
-- Table structure for table `ospos_mail config`
--

CREATE TABLE `ospos_email_config` (
 ...
 `oauth_project_name` varchar(255) DEFAULT NULL,
 `oauth_client_id` varchar(255) DEFAULT NULL,
 `oauth_client_secret` varchar(255) DEFAULT NULL,
 `oauth_developer_key` varchar(255) DEFAULT NULL,
 `smtp_certificate` varchar(255) DEFAULT NULL,
 `user_email` varchar(255) DEFAULT NULL,
 `user_token` varchar(65535) DEFAULT NULL,
  KEY `protocol` (`protocol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


--
-- Dumping data for table `ospos_email_config`
--

INSERT INTO `ospos_email_config` (`protocol`, `email`, `oauth_project_name`, `oauth_client_id`, `oauth_client_secret`, `oauth_developer_key`) VALUES
('google_oauth', 'datta@atrium-tech.com', 'ospos-email', '754322026557-s7q2bdr5iiqnlf4bb81c9e32cupp88ej.apps.googleusercontent.com','HuJ0_KzqwFz0PKAo1yTT2vmH','AIzaSyA41Bfdl5rQNfvkpL_IpMWPJogCaXFWFzE');
